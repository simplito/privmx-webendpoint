...
EMSCRIPTEN_BINDINGS(webendpoint) {
    ...
    BINDING_FUNCTION(Connection, listContextUsers)
    BINDING_FUNCTION(Connection, subscribeFor)
    BINDING_FUNCTION(Connection, unsubscribeFrom)
    BINDING_FUNCTION(Connection, buildSubscriptionQuery)
    ...
    BINDING_FUNCTION(GroupApi, addGroupMembers)
    BINDING_FUNCTION(GroupApi, removeGroupMembers)
    BINDING_FUNCTION(GroupApi, updateGroupPublicMeta)
    BINDING_FUNCTION(GroupApi, updateGroupPrivateMeta)
    BINDING_FUNCTION(GroupApi, updateGroupPolicy)
    BINDING_FUNCTION(GroupApi, deleteGroup)
    BINDING_FUNCTION(GroupApi, getGroup)
    BINDING_FUNCTION(GroupApi, listGroups)
    BINDING_FUNCTION(GroupApi, encrypt)
    BINDING_FUNCTION(GroupApi, encryptAnonymously)
    BINDING_FUNCTION(GroupApi, decrypt)
    BINDING_FUNCTION(GroupApi, beginFileEncryption)
    BINDING_FUNCTION(GroupApi, beginFileEncryptionAnonymously)
    BINDING_FUNCTION(GroupApi, encryptFileChunk)
    BINDING_FUNCTION(GroupApi, finishFileEncryption)
    BINDING_FUNCTION(GroupApi, beginFileDecryption)
    BINDING_FUNCTION(GroupApi, decryptFileChunk)
    BINDING_FUNCTION(GroupApi, seekInEncryptedFile)
    BINDING_FUNCTION(GroupApi, finishFileDecryption)
    BINDING_FUNCTION(GroupApi, sendCustomEvent)
    BINDING_FUNCTION(GroupApi, subscribeFor)
    BINDING_FUNCTION(GroupApi, unsubscribeFrom)
    BINDING_FUNCTION(GroupApi, buildSubscriptionQuery)
    BINDING_FUNCTION(GroupApi, buildCustomEventSubscriptionQuery)
    ...
    BINDING_FUNCTION(ThreadApi, rotateThreadKeys)
    BINDING_FUNCTION(ThreadApi, subscribeFor)
    BINDING_FUNCTION(ThreadApi, unsubscribeFrom)
    BINDING_FUNCTION(ThreadApi, buildSubscriptionQuery)
    ...
    BINDING_FUNCTION(StoreApi, rotateStoreKeys)
    ...
    BINDING_FUNCTION(InboxApi, rotateInboxKeys)
    BINDING_FUNCTION(InboxApi, subscribeFor)
    BINDING_FUNCTION(InboxApi, unsubscribeFrom)
    BINDING_FUNCTION(InboxApi, buildSubscriptionQuery)
    ...
    BINDING_FUNCTION(KvdbApi, rotateKvdbKeys)
    ...
    BINDING_FUNCTION(EventApi, subscribeFor)
    BINDING_FUNCTION(EventApi, unsubscribeFrom)
    BINDING_FUNCTION(EventApi, buildSubscriptionQuery)
    ...
    BINDING_FUNCTION(StreamApi, createStreamRoom)
    BINDING_FUNCTION(StreamApi, updateStreamRoom)
    BINDING_FUNCTION(StreamApi, deleteStreamRoom)
    BINDING_FUNCTION(StreamApi, getStreamRoom)
    ...
    BINDING_FUNCTION(StreamApi, removeStream)
    ...
    BINDING_FUNCTION(StreamApi, removeSubscriberStream)

    BINDING_FUNCTION(StreamApi, rotateStreamRoomKeys)
    ...
    BINDING_FUNCTION(SearchApi, newSearchApi)
    BINDING_FUNCTION(SearchApi, deleteSearchApi)
    ...
    BINDING_FUNCTION(SearchApi, openSearchIndex)
    BINDING_FUNCTION(SearchApi, closeSearchIndex)
    BINDING_FUNCTION(SearchApi, addDocument)
    BINDING_FUNCTION(SearchApi, updateDocument)
    BINDING_FUNCTION(SearchApi, deleteDocument)
    ...
    BINDING_FUNCTION(LockApi, create)
    BINDING_FUNCTION(LockApi, lock)
    BINDING_FUNCTION(LockApi, unlock)
    BINDING_FUNCTION(LockApi, checkReservedLock)
}
