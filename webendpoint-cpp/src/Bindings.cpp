...
EMSCRIPTEN_BINDINGS(webendpoint) {
    ...
    BINDING_FUNCTION(SqlApi, newSqlApi)
    BINDING_FUNCTION(SqlApi, deleteSqlApi)
    BINDING_FUNCTION(SqlApi, create)
    BINDING_FUNCTION(SqlApi, createSqlDatabase)
    BINDING_FUNCTION(SqlApi, updateSqlDatabase)
    BINDING_FUNCTION(SqlApi, deleteSqlDatabase)
    BINDING_FUNCTION(SqlApi, getSqlDatabase)
    BINDING_FUNCTION(SqlApi, listSqlDatabases)
    BINDING_FUNCTION(SqlApi, openSqlDatabase)
    BINDING_FUNCTION(SqlApi, databaseHandleBeginTransaction)
    BINDING_FUNCTION(SqlApi, databaseHandleQuery)
    BINDING_FUNCTION(SqlApi, databaseHandleClose)
    BINDING_FUNCTION(SqlApi, freeDatabaseHandle)
    BINDING_FUNCTION(SqlApi, transactionQuery)
    BINDING_FUNCTION(SqlApi, transactionCommit)
    BINDING_FUNCTION(SqlApi, transactionRollback)
    BINDING_FUNCTION(SqlApi, freeTransaction)
    BINDING_FUNCTION(SqlApi, queryBindInt64)
    BINDING_FUNCTION(SqlApi, queryBindDouble)
    BINDING_FUNCTION(SqlApi, queryBindText)
    BINDING_FUNCTION(SqlApi, queryBindBlob)
    ...
    BINDING_FUNCTION(SqlApi, rowGetColumn)
    BINDING_FUNCTION(SqlApi, freeRow)
    BINDING_FUNCTION(SqlApi, columnGetName)
    BINDING_FUNCTION(SqlApi, columnGetType)
    BINDING_FUNCTION(SqlApi, columnGetInt64)
    BINDING_FUNCTION(SqlApi, columnGetDouble)
    BINDING_FUNCTION(SqlApi, columnGetText)
    BINDING_FUNCTION(SqlApi, columnGetBlob)
    BINDING_FUNCTION(SqlApi, freeColumn)
}
