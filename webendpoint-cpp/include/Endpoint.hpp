...
void SqlApi_newSqlApi(int taskId, int connectionPtr, int storePtr, int kvdbPtr);
void SqlApi_deleteSqlApi(int taskId, int ptr);
API_FUNCTION_HEADER(SqlApi, create)
API_FUNCTION_HEADER(SqlApi, createSqlDatabase)
API_FUNCTION_HEADER(SqlApi, updateSqlDatabase)
API_FUNCTION_HEADER(SqlApi, deleteSqlDatabase)
API_FUNCTION_HEADER(SqlApi, getSqlDatabase)
API_FUNCTION_HEADER(SqlApi, listSqlDatabases)
API_FUNCTION_HEADER(SqlApi, openSqlDatabase)
API_FUNCTION_HEADER(SqlApi, databaseHandleBeginTransaction)
API_FUNCTION_HEADER(SqlApi, databaseHandleQuery)
API_FUNCTION_HEADER(SqlApi, databaseHandleClose)
API_FUNCTION_HEADER(SqlApi, freeDatabaseHandle)
API_FUNCTION_HEADER(SqlApi, transactionQuery)
API_FUNCTION_HEADER(SqlApi, transactionCommit)
API_FUNCTION_HEADER(SqlApi, transactionRollback)
API_FUNCTION_HEADER(SqlApi, freeTransaction)
API_FUNCTION_HEADER(SqlApi, queryBindInt64)
API_FUNCTION_HEADER(SqlApi, queryBindDouble)
API_FUNCTION_HEADER(SqlApi, queryBindText)
API_FUNCTION_HEADER(SqlApi, queryBindBlob)
API_FUNCTION_HEADER(SqlApi, queryBindNull)
API_FUNCTION_HEADER(SqlApi, queryStep)
API_FUNCTION_HEADER(SqlApi, queryReset)
API_FUNCTION_HEADER(SqlApi, queryFinalize)
API_FUNCTION_HEADER(SqlApi, freeQuery)
API_FUNCTION_HEADER(SqlApi, rowGetStatus)
API_FUNCTION_HEADER(SqlApi, rowGetColumnCount)
API_FUNCTION_HEADER(SqlApi, rowGetColumn)
API_FUNCTION_HEADER(SqlApi, freeRow)
API_FUNCTION_HEADER(SqlApi, columnGetName)
API_FUNCTION_HEADER(SqlApi, columnGetType)
API_FUNCTION_HEADER(SqlApi, columnGetInt64)
API_FUNCTION_HEADER(SqlApi, columnGetDouble)
API_FUNCTION_HEADER(SqlApi, columnGetText)
API_FUNCTION_HEADER(SqlApi, columnGetBlob)
API_FUNCTION_HEADER(SqlApi, freeColumn)
