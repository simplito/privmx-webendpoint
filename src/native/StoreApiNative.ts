...
export class StoreApiNative extends BaseNative {
    ...
    async createStore(
        ...
        return this.runAsync<string>((taskId) =>
            this.api.lib.StoreApi_createStore(taskId, ptr, args),
        );
    }
    async updateStore(
        ptr: number,
    ...
    async deleteStore(ptr: number, args: [string]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.StoreApi_deleteStore(taskId, ptr, args),
        );
    }
    ...
    async listStores(ptr: number, args: [string, PagingQuery]): Promise<PagingList<Store>> {
        return this.runAsync<PagingList<Store>>((taskId) =>
            this.api.lib.StoreApi_listStores(taskId, ptr, args),
        );
    }
    async createFile(
        ptr: number,
        args: [string, Uint8Array, Uint8Array, number, boolean],
    ): Promise<number> {
        return this.runAsync<number>((taskId) =>
            this.api.lib.StoreApi_createFile(taskId, ptr, args),
        );
    }
    async updateFile(ptr: number, args: [string, Uint8Array, Uint8Array, number]): Promise<number> {
        return this.runAsync<number>((taskId) =>
            this.api.lib.StoreApi_updateFile(taskId, ptr, args),
        );
    }
    async updateFileMeta(ptr: number, args: [string, Uint8Array, Uint8Array]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.StoreApi_updateFileMeta(taskId, ptr, args),
        );
    }
    async writeToFile(ptr: number, args: [number, Uint8Array, boolean]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.StoreApi_writeToFile(taskId, ptr, args),
        );
    }
    ...
    async listFiles(ptr: number, args: [string, PagingQuery]): Promise<PagingList<File>> {
        return this.runAsync<PagingList<File>>((taskId) =>
            this.api.lib.StoreApi_listFiles(taskId, ptr, args),
        );
    }
    ...
    async readFromFile(ptr: number, args: [number, number]): Promise<Uint8Array> {
        return this.runAsync<Uint8Array>((taskId) =>
            this.api.lib.StoreApi_readFromFile(taskId, ptr, args),
        );
    }
    ...
    async closeFile(ptr: number, args: [number]): Promise<string> {
        return this.runAsync<string>((taskId) =>
            this.api.lib.StoreApi_closeFile(taskId, ptr, args),
        );
    }
    async syncFile(ptr: number, args: [number]): Promise<void> {
        return this.runAsync<void>((taskId) => this.api.lib.StoreApi_syncFile(taskId, ptr, args));
    }
    async subscribeFor(ptr: number, args: [string[]]): Promise<string[]> {
        return this.runAsync<string[]>((taskId) =>
            this.api.lib.StoreApi_subscribeFor(taskId, ptr, args),
        );
    }
    async unsubscribeFrom(ptr: number, args: [string[]]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.StoreApi_unsubscribeFrom(taskId, ptr, args),
        );
    }
    async buildSubscriptionQuery(
        ptr: number,
        args: [StoreEventType, StoreEventSelectorType, string],
    ): Promise<string> {
        return this.runAsync<string>((taskId) =>
            this.api.lib.StoreApi_buildSubscriptionQuery(taskId, ptr, args),
        );
    }
}
