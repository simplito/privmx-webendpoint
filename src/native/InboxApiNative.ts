...
export class InboxApiNative extends BaseNative {
    ...
    async createInbox(
        ...
        return this.runAsync<string>((taskId) =>
            this.api.lib.InboxApi_createInbox(taskId, ptr, args),
        );
    }
    async updateInbox(
        ptr: number,
    ...
    async listInboxes(ptr: number, args: [string, PagingQuery]): Promise<PagingList<Inbox>> {
        return this.runAsync<PagingList<Inbox>>((taskId) =>
            this.api.lib.InboxApi_listInboxes(taskId, ptr, args),
        );
    }
    async getInboxPublicView(ptr: number, args: [string]): Promise<InboxPublicView> {
        return this.runAsync<InboxPublicView>((taskId) =>
            this.api.lib.InboxApi_getInboxPublicView(taskId, ptr, args),
        );
    }
    async deleteInbox(ptr: number, args: [string]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.InboxApi_deleteInbox(taskId, ptr, args),
        );
    }
    async prepareEntry(
        ptr: number,
        args: [string, Uint8Array, number[], string | undefined],
    ): Promise<number> {
        return this.runAsync<number>((taskId) =>
            this.api.lib.InboxApi_prepareEntry(taskId, ptr, args),
        );
    }
    ...
    async readEntry(ptr: number, args: [string]): Promise<InboxEntry> {
        return this.runAsync<InboxEntry>((taskId) =>
            this.api.lib.InboxApi_readEntry(taskId, ptr, args),
        );
    }
    async deleteEntry(ptr: number, args: [string]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.InboxApi_deleteEntry(taskId, ptr, args),
        );
    }
    async listEntries(ptr: number, args: [string, PagingQuery]): Promise<PagingList<InboxEntry>> {
        return this.runAsync<PagingList<InboxEntry>>((taskId) =>
            this.api.lib.InboxApi_listEntries(taskId, ptr, args),
        );
    }
    async createFileHandle(ptr: number, args: [Uint8Array, Uint8Array, number]): Promise<number> {
        return this.runAsync<number>((taskId) =>
            this.api.lib.InboxApi_createFileHandle(taskId, ptr, args),
        );
    }
    async writeToFile(ptr: number, args: [number, number, Uint8Array]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.InboxApi_writeToFile(taskId, ptr, args),
        );
    }
    ...
    async readFromFile(ptr: number, args: [number, number]): Promise<Uint8Array> {
        return this.runAsync<Uint8Array>((taskId) =>
            this.api.lib.InboxApi_readFromFile(taskId, ptr, args),
        );
    }
    ...
    async closeFile(ptr: number, args: [number]): Promise<string> {
        return this.runAsync<string>((taskId) =>
            this.api.lib.InboxApi_closeFile(taskId, ptr, args),
        );
    }
    async subscribeFor(ptr: number, args: [string[]]): Promise<string[]> {
        return this.runAsync<string[]>((taskId) =>
            this.api.lib.InboxApi_subscribeFor(taskId, ptr, args),
        );
    }
    async unsubscribeFrom(ptr: number, args: [string[]]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.InboxApi_unsubscribeFrom(taskId, ptr, args),
        );
    }
    async buildSubscriptionQuery(
        ptr: number,
        args: [InboxEventType, InboxEventSelectorType, string],
    ): Promise<string> {
        return this.runAsync<string>((taskId) =>
            this.api.lib.InboxApi_buildSubscriptionQuery(taskId, ptr, args),
        );
    }
}
