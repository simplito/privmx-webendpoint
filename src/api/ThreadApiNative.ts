...
export class ThreadApiNative extends BaseNative {
    ...
    async createThread(
        ...
        return this.runAsync<string>((taskId) =>
            this.api.lib.ThreadApi_createThread(taskId, ptr, args),
        );
    }
    async updateThread(
        ptr: number,
    ...
    async deleteThread(ptr: number, args: [string]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.ThreadApi_deleteThread(taskId, ptr, args),
        );
    }
    async getThread(ptr: number, args: [string]): Promise<Thread> {
        return this.runAsync<Thread>((taskId) =>
            this.api.lib.ThreadApi_getThread(taskId, ptr, args),
        );
    }
    async listThreads(ptr: number, args: [string, PagingQuery]): Promise<PagingList<Thread>> {
        return this.runAsync<PagingList<Thread>>((taskId) =>
            this.api.lib.ThreadApi_listThreads(taskId, ptr, args),
        );
    }
    async getMessage(ptr: number, args: [string]): Promise<Message> {
        return this.runAsync<Message>((taskId) =>
            this.api.lib.ThreadApi_getMessage(taskId, ptr, args),
        );
    }
    async listMessages(ptr: number, args: [string, PagingQuery]): Promise<PagingList<Message>> {
        return this.runAsync<PagingList<Message>>((taskId) =>
            this.api.lib.ThreadApi_listMessages(taskId, ptr, args),
        );
    }
    async sendMessage(
        ptr: number,
        args: [string, Uint8Array, Uint8Array, Uint8Array],
    ): Promise<string> {
        return this.runAsync<string>((taskId) =>
            this.api.lib.ThreadApi_sendMessage(taskId, ptr, args),
        );
    }
    async deleteMessage(ptr: number, args: [string]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.ThreadApi_deleteMessage(taskId, ptr, args),
        );
    }
    async updateMessage(
        ptr: number,
        ...
        return this.runAsync<void>((taskId) =>
            this.api.lib.ThreadApi_updateMessage(taskId, ptr, args),
        );
    }
    async subscribeFor(ptr: number, args: [string[]]): Promise<string[]> {
        return this.runAsync<string[]>((taskId) =>
            this.api.lib.ThreadApi_subscribeFor(taskId, ptr, args),
        );
    }
    async unsubscribeFrom(ptr: number, args: [string[]]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.ThreadApi_unsubscribeFrom(taskId, ptr, args),
        );
    }
    async buildSubscriptionQuery(
        ptr: number,
        args: [ThreadEventType, ThreadEventSelectorType, string],
    ): Promise<string> {
        return this.runAsync<string>((taskId) =>
            this.api.lib.ThreadApi_buildSubscriptionQuery(taskId, ptr, args),
        );
    }
}
