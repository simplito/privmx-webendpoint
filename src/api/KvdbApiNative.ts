...
export class KvdbApiNative extends BaseNative {
    ...
    async createKvdb(
        ...
        return this.runAsync<string>((taskId) =>
            this.api.lib.KvdbApi_createKvdb(taskId, ptr, args),
        );
    }
    async updateKvdb(
        ptr: number,
    ...
    async listKvdbs(ptr: number, args: [string, PagingQuery]): Promise<PagingList<Kvdb>> {
        return this.runAsync<PagingList<Kvdb>>((taskId) =>
            this.api.lib.KvdbApi_listKvdbs(taskId, ptr, args),
        );
    }
    ...
    async getEntry(ptr: number, args: [string, string]): Promise<KvdbEntry> {
        return this.runAsync<KvdbEntry>((taskId) =>
            this.api.lib.KvdbApi_getEntry(taskId, ptr, args),
        );
    }
    async listEntriesKeys(ptr: number, args: [string, PagingQuery]): Promise<PagingList<string>> {
        return this.runAsync<PagingList<string>>((taskId) =>
            this.api.lib.KvdbApi_listEntriesKeys(taskId, ptr, args),
        );
    }
    async listEntries(ptr: number, args: [string, PagingQuery]): Promise<PagingList<KvdbEntry>> {
        return this.runAsync<PagingList<KvdbEntry>>((taskId) =>
            this.api.lib.KvdbApi_listEntries(taskId, ptr, args),
        );
    }
    async setEntry(
        ptr: number,
        args: [string, string, Uint8Array, Uint8Array, Uint8Array, number],
    ): Promise<void> {
    ...
    async deleteEntries(ptr: number, args: [string, string[]]): Promise<DeleteEntriesResult> {
        return this.runAsync<DeleteEntriesResult>((taskId) =>
            this.api.lib.KvdbApi_deleteEntries(taskId, ptr, args),
        );
    }
    async subscribeFor(ptr: number, args: [string[]]): Promise<string[]> {
        return this.runAsync<string[]>((taskId) =>
            this.api.lib.KvdbApi_subscribeFor(taskId, ptr, args),
        );
    }
    async unsubscribeFrom(ptr: number, args: [string[]]): Promise<void> {
        return this.runAsync<void>((taskId) =>
            this.api.lib.KvdbApi_unsubscribeFrom(taskId, ptr, args),
        );
    }
    async buildSubscriptionQuery(
        ptr: number,
        args: [KvdbEventType, KvdbEventSelectorType, string],
    ): Promise<string> {
        return this.runAsync<string>((taskId) =>
            this.api.lib.KvdbApi_buildSubscriptionQuery(taskId, ptr, args),
        );
    }
    async buildSubscriptionQueryForSelectedEntry(
        ptr: number,
        args: [KvdbEventType, string, string],
    ): Promise<string> {
        return this.runAsync<string>((taskId) =>
            this.api.lib.KvdbApi_buildSubscriptionQueryForSelectedEntry(taskId, ptr, args),
        );
    }
}
